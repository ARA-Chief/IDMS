...
| `schedule.js`      | Schedule (tabbed: Schedule · Setup · Trip Reference) — year selector, editable crew grid, fishery picker, crew totals, re-anchor logic | ✅ Complete  |
...
**Edited by:** Admin (via console Administration → Crew Setup → Crew List tab)
